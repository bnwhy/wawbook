...
import hardcoverIcon from '@assets/generated_images/simple_hardcover_book_icon.png';
import softcoverIcon from '@assets/generated_images/simple_softcover_book_icon.png';
