    ...
    <nav className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <Sheet>
            ...
            <SheetContent side="left">
              <div className="flex flex-col gap-4 mt-8">
                ...
                <Link href="/gifts" className="text-lg font-medium">Gifts</Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link href="/books">
            <a className="text-sm font-medium hover:text-primary transition-colors">Books</a>
          </Link>
          <Link href="/gifts">
            <a className="text-sm font-medium hover:text-primary transition-colors">Gifts</a>
          </Link>
          <Link href="/about">
