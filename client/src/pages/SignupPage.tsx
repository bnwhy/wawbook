...
const SignupPage = () => {
  ...
  const handleAppleSignup = () => {
    window.location.href = '/api/auth/apple?returnTo=/account';
  };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-brand-cream">
      ...
      <main className="flex-1 flex relative min-h-[calc(100vh-80px)]">
        {/* Left Side - Branding */}
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-cloud-lightest to-cloud-lighter p-12 pt-32 flex-col justify-start items-center relative overflow-hidden">
          {/* Top Wave Divider */}
          ...
          <div className="max-w-lg w-full text-center mt-8">
            <h2 className="font-display font-black text-4xl md:text-5xl text-cloud-dark leading-tight mb-6">
              Rejoignez<br />le nuage<span className="text-cloud-blue relative inline-block">club
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <label htmlFor="acceptTerms" className="text-sm text-stone-600">
                    J'accepte les{' '}
                    <Link href="/terms" className="text-cloud-blue hover:underline font-medium">
                      conditions générales d'utilisation
                    </Link>
                    {' '}et la{' '}
                    <Link href="/privacy" className="text-cloud-blue hover:underline font-medium">
